...
class RiscvArch(ArchetectureInterface):
    supported_extensions = {"i", "m", "a", "f", "d", "c", "zicsr", "zifencei"}
    arch_name = "RISC-V"
    abs_jump_mnemonic = "j"
    jump_commands = [
        "j",
    ...
    def get_directive(line: str) -> Directive:
        ...
        if a.strip() in RiscvAttributeDirective.directives:
            return RiscvAttributeDirective(a, b, RiscvArch.supported_extensions)
            ...
            while ptr < len(lines):
                ...
                if isinstance(line, RiscvObjectDirective):
                    ...
                    if label_text in objects:
                        ...
                        elif objects[label_text] == "data" or object[label_text] == "sdata":
